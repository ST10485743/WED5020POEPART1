# WEB DEVELOPMENT POE PART 1 WED5020POEPART1
...
2. **Navigation Bar:**
   By using the <href> this helps to link the webpages and it also counts as the navigation bar of the website.The <href> makes it easier for the user to understand which links directs them to which page.
3. **Hero Image:**
   This image is what draws the main focus of the user, it persuades them to go further and use the website.
4. **Forms:**
   These forms are for the user to enter their details and to enquire about products that are being sold.
5. **Use of different browsers:**
...
**Changelog**
1. Changed the brief introduction from being a text into a Hero Image.
